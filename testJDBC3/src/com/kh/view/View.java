...
public class View {
	...
	public void mainMenu() {
		...
		do {
			...
			if(mem == null) {
				...
				System.out.println("1. 로그아웃"); // null이 아닐 때는 로그인이 되어 있다는 이야기
	...
	public Member inputLogoin() {
		mem = new Member(); 
//		member를 객체로 만들면서 null이 아니고 값이 채워져 있는 상태가 되기 때문에 비밀번호가 틀려도 게시판 프로그램을 사용할 수 있게됨
//		displayLoginError()에 mem = null;로 해줘야 비밀번호가 틀리면 사용 안됨
